...
class eff_mea:
    ...
    def __init__(self, excel0, pwr0, pwr_ch0, met_v0, loader_0, mcu0, src0, met_i0, chamber0):
        ...
        if self.excel_ini.channel_mode == 0:
            self.excel_ini.extra_file_name = 'EL_EFF'
            pass
        elif self.excel_ini.channel_mode == 1:
            self.excel_ini.extra_file_name = 'AVDD_EFF'
            pass
        elif self.excel_ini.channel_mode == 2:
            self.excel_ini.extra_file_name = '3ch_EFF'
            pass
        pass
...
if __name__ == '__main__':
    ...
    # create one file
    eff_test = eff_mea(excel1, pwr_t, 3, met_v_t, load_t, mcu_t)
